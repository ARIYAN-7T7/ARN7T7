...
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
echo -e "${B}${C_B_YLW}  PROTOCOL COMPLETE. MAINTAINER: ARIYAN 7T7${R}"
echo -e "${C_D_GRN}  [*] GitHub       : ${C_B_GRN}ARIYAN-7T7${R}"
echo -e "${C_D_GRN}  [*] Facebook     : ${C_B_GRN}ariyan.ahmed.7t7${R}"
echo -e "${C_D_GRN}  [*] Telegram     : ${C_B_GRN}@ariyan_7t7${R}"
echo -e "${C_D_GRN}  [*] YouTube      : ${C_B_GRN}@ariyan_7t7${R}"
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
